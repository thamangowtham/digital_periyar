 ...
 * @endcode
 */
$settings['hash_salt'] = 'PV-7fW09lp7NCX3GFKOKyX7oI4CrOKADGOXdgS3hGvFgOboJVJ8B32zRcTXTLFHI5PCFpDBKG3';
...
$settings['flysystem']['fedora']['config']['root'] = 'http://digitalperiyar.com:8081/fcrepo/rest/';
$settings['reverse_proxy'] = true;
$settings['reverse_proxy_addresses'] = array (
  0 => '172.19.0.3',
);
$settings['reverse_proxy_trusted_headers'] = 26;
$databases['default']['default']['database'] = 'drupal_default';
$databases['default']['default']['username'] = 'drupal_default';
$databases['default']['default']['password'] = 'lOLUFSd4fudOS2HxPsrg2jQap9FB5utvCwQWmVdwmHHgx2LF';
